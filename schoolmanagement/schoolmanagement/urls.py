...
urlpatterns = [
    ...
    path('adminclick', views.adminclick_view, name='admin'),
    path('teacherclick', views.teacherclick_view, name='teacher'),
    path('studentclick', views.studentclick_view, name='student'),
